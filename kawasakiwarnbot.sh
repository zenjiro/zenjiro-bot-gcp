...
do
    ...
    [ -f .kawasakiwarnbot-last ] && diff .kawasakiwarnbot-now .kawasakiwarnbot-last > /dev/null || (cat .kawasakiwarnbot-now && ~/kawasakiwarnbot/tweet.sh post < .kawasakiwarnbot-now)
